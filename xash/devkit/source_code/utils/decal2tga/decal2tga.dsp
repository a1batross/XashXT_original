...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../../client" /I "../../common" /I "../../server" /I "../../engine" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /FD /c
# SUBTRACT CPP /Fr /YX
...
# Begin Custom Build
TargetDir=\Xash3D\xash\devkit\source_code\temp\decal2tga\!release
InputPath=\Xash3D\xash\devkit\source_code\temp\decal2tga\!release\decal2tga.exe
SOURCE="$(InputPath)"

"D:\Xash3D\xash\devkit\tools\decal2tga.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\decal2tga.exe "D:\Xash3D\xash\devkit\tools\decal2tga.exe"
...
# Begin Custom Build
TargetDir=\Xash3D\xash\devkit\source_code\temp\decal2tga\!debug
InputPath=\Xash3D\xash\devkit\source_code\temp\decal2tga\!debug\decal2tga.exe
SOURCE="$(InputPath)"
