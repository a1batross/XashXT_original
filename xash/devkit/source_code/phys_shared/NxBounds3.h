...
class NxBounds3
	...
	*/
	...
	/**
	\brief indicates whether the b inside a.

	\param b Bounds to test for inside.
	*/
	NX_INLINE bool inside(const NxBounds3& box) const;
...
NX_INLINE bool NxBounds3::inside(const NxBounds3& box) const
{
